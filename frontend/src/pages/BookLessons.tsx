      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm mb-8">
          ...
          <form className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Do you have a drum kit at home?</label>
              <div className="flex space-x-4">
                <label className="flex items-center space-x-2">
                  <input type="radio" name="has_kit" className="h-4 w-4 text-indigo-600" />
                ...
                <label className="flex items-center space-x-2">
                  <input type="radio" name="has_kit" className="h-4 w-4 text-indigo-600" />
                  <span className="text-gray-700">Electronic Kit Only</span>
                </label>
              </div>
            </div>
